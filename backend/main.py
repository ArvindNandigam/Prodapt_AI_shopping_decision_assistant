...
async def search_endpoint(req: SearchRequest, request: Request) -> SearchResponse:
    ...
    if comparison:
        ...
        for candidate in candidates:
            ...
            advantages = (rec.advantages if rec and rec.advantages else rec.pros if rec else [])
            disadvantages = (rec.disadvantages if rec and rec.disadvantages else rec.cons if rec else [])
            enriched.append({
                **candidate,
